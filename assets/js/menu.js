$(function () {
    ...
    $menuLi.hover(function () {
        ...
        if (len <= 0) { len = -len; };
        if (num != 3) {
            $menu.stop().animate({ backgroundPosition: (106 * num) + "px" + " bottom" }, 100 * len);
        }
        else {
            $menu.stop().animate({ backgroundPosition: (106 * num + 30) + "px" + " bottom" }, 100 * len);
        }
    });
    $li_3.hover(function () {
    ...
    $menu.mouseleave(function () {
        ...
        if (len <= 0) { len = -len; };
        $menu.stop().animate({ backgroundPosition: (106 * current + 1) + "px" + " bottom" }, 100 * len);
    });
