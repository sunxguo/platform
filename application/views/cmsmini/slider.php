...
<h3 <?php echo isset($appManager) && $appManager?'class="current"':'';?>>
	<a href="/cmsmini/index/app" id="menu_manageApp">
...
<ul style="display: block;">
	<li><a href="/cmsmini/index/publish?appid=<?php echo $info->id_app;?>" <?php echo isset($publish) && $publish?'class="current"':'';?>><?php echo lang('cms_sider_publishcontent');?></a></li>
	<li><a href="/cmsmini/index/contents?appid=<?php echo $info->id_app;?>" <?php echo isset($contents) && $contents?'class="current"':'';?>><?php echo lang('cms_sider_selectcontent');?></a></li>
	<li><a href="/cmsmini/index/form?appid=<?php echo $info->id_app;?>" <?php echo isset($form) && $form?'class="current"':'';?>><?php echo lang('cms_sider_formdata');?></a></li>
	<li><a href="/cmsmini/index/orders?appid=<?php echo $info->id_app;?>" <?php echo isset($orders) && $orders?'class="current"':'';?>><?php echo lang('cms_sider_orders');?></a></li>
	<li><a href="/cmsmini/index/users?appid=<?php echo $info->id_app;?>" <?php echo isset($users) && $users?'class="current"':'';?>><?php echo lang('cms_sider_users');?></a></li>
<!--
