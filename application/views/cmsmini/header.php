    ...
    <div class="header-cms">
        ...
        */?>
		<ul class="menu-cms">
			...
			<li class="message">
				<a href="/cmsmini/index/message?type=2" title="<?php echo lang('cms_user_message');?>" id="js-openmsg">
                <img src="/assets/images/cms/ico_mail.png" width="24" height="24"></a>
				<span id="unreadMesNumber"></span>
			</li>
			<li class="logout">
				<a href="/cmsmini/index/logout" title="<?php echo lang('cms_user_logout');?>"><?php echo lang('cms_user_logout');?></a>
			</li>
			<li class="language">
