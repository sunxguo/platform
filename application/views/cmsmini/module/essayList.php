<div class="padding10 contentlist">
	<div id="appDiv" class="titA tit-bot pb5" style="">
		<div style="float: left;margin-left:10px;">
			<a href="/cmsmini/module/addEssay?nav=<?php echo $nav->id_nav;?>" class="btn80">+ 添加</a>
		</div>
	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="/cmsmini/module/essay?essayid=<?php echo $e->id_essay;?>"><?php echo $e->title_essay;?></a></td>
