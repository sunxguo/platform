<div class="padding10 contentlist">
	<div id="appDiv" class="titA tit-bot pb5" style="">
		<div class="tabDiv" style="width:100%;">
			...
			<div onclick="location.href='/kmadmin/admin/market_necessity'" class="center active" style="width:120px;">
				装机必备
			</div>
	...
	<table>
		...
		<tbody>
			<?php foreach($necessity->app as $a):?>
			<tr>
				...
				<td>
					...
					<a class="del-essay" href="javascript:check_app('<?php echo $a->id_app;?>');">审核通过</a>
					<?php endif;?>
					<a class="del-essay" href="javascript:app_union('<?php echo $a->id_app;?>','<?php echo $necessity->id_marketunion;?>','drop');">移除</a>
